...
# df_samples = pd.read_csv('/Users/michael/Downloads/somalier.samples.tsv', sep='\t')
# df_pairs = pd.read_csv('/Users/michael/Downloads/somalier.pairs.tsv', sep='\t')
# manifest_file = '/Users/michael/Downloads/pedigree.ped'
...
# write the other two tabs from the original xls file
writer = excelAutofit(sheets[1][sheets[1].columns[:100]], 'DNA Fingerprints', writer,
                      pcts=[col for col in sheets[1].columns if
